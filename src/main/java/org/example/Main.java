...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        employees.add(new Employee(1, "orhun", "orhun"));
        employees.add(new Employee(1, "orhun", "orhun"));
        employees.add(new Employee(1, "orhun", "orhun"));
        employees.add(new Employee(2, "zeynep", "zener"));
        employees.add(new Employee(2, "zeynep", "zener"));
        employees.add(new Employee(3, "serdar", "dayıcıoğlu"));
        employees.add(new Employee(4, "hakan", "yavaş"));
        employees.add(new Employee(5, "osman", "ciğerci"));
